    ...
    return (
        <div className="flex gap-[30px]">
            <div className='w-[350px] h-[204px] bg-[#F1F1F1] rounded-md pb-[30px] flex flex-col justify-end items-center '>
                ...
                <Link to='/headphones' className="flex items-center gap-[13px] text-[13px] font-bold uppercase opacity-50 hover:opacity-100 hover:text-[#D87D4A] leading-[18px] tracking-[1px]">
            ...
            <div className='w-[350px] h-[204px] bg-[#F1F1F1] rounded-md pb-[30px] flex flex-col justify-end items-center '>
                ...
                <Link to='/headphones' className="flex items-center gap-[13px] text-[13px] hover:opacity-100 hover:text-[#D87D4A] font-bold uppercase opacity-50 leading-[18px] tracking-[1px]">
                    Shop <FaChevronRight size={11} className="text-[#D87D4A] " />
                </Link>
            </div>
